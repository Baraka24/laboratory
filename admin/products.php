...
<div class="main"><!-- start main -->
  ...
  ?>
<a href="addProduct.php" class="notification">
  <span><i class="fa fa-upload"></i>Nouveau produit</span>
  <span class="badge">
   <?php
...
<hr>
<!-- search input -->
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Rechercher par produit.." title="Type in a name">
<!-- search input -->
<!-- div to be printed -->
...
<tr>
      ...
      <td><?=$row['description']?></td>
      <td>
      <a href="updateProduct.php?id=<?=$row['id']?>" style="text-decoration:none;">
       <h5>
        <span class="badge"><i class="fa fa-edit"></i>Modifier</span>
       </h5>
      </a>
      <a href="actions/deleteProduct.php?id=<?=$row['id']?>" style="text-decoration:none;">
       <h5>
